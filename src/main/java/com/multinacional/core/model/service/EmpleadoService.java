...
public class EmpleadoService implements IEmpleadoService {
    ...
    public EmpleadoMinOutputDto findMinByEmpleado(Long idEmployable) {
        Optional<Empleado> opEmployable = IEmpleadoDAO.findById(idEmployable);
